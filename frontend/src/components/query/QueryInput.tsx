    ...
    <form onSubmit={handleFormSubmit} className="space-y-4 w-full text-left">
      <div className="relative">
        <TextArea
          ...
          disabled={isLoading}
        />
        <div className="absolute right-4.5 bottom-4.5 flex items-center space-x-2">
          <span className="hidden sm:inline text-[10px] text-text-secondaryLight dark:text-text-secondaryDark font-semibold bg-slate-100 dark:bg-slate-800 px-2 py-1 rounded">
            Ctrl + Enter
          </span>
          <Button
            type="submit"
